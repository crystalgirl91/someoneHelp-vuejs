...
<div class="padding-b-1">
	<div class="course_detail">
		...
		<div class="course_detail_title clearfix">
			<span class="left"><i :style="{color:'#ea8010'}" class="icon-sign"></i>&nbsp;&nbsp;评论</span>
		</div>
		<div class="list">
...
<script>
	...
	export default{
		...
		methods:{
			getList:function(){
				return this.$http.post("/API/Student/GetCurriculumComment",{
					"PK_CID":this.id,
					"PageIndex":1,
					"PageSize":100
				}).then(res => {
			...
			comment:function(){
				return this.$http.post("/API/Student/SetCurriculumComment",{
					"PK_CID":this.id,
