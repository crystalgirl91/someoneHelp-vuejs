<template>
	...
	<m-header :title="TName"></m-header>
	<tab active-color="#ff9100">
		<tab-item :selected="selected === 0" @click="selected = 0">老师说</tab-item>
		<tab-item :selected="selected === 1" @click="selected = 1">大家说</tab-item>
	</tab>
	<div class="plat_teacher">
		<section class="plat_teacher-c" v-show="selected === 0">
			...
			<p class="m-btn-wrap"><button v-link="{'name':'c_class_detail_comment',params:{'id':this.$route.params.PK_TID}}" class="weui_btn weui_btn_normal">评 论</button></p>
		</section>
		<section class="plat_teacher-c" v-show="selected ===1">
			<div class="m-card-tips" v-for="item in rows">
				<flexbox align="flex-start">
					<flexbox-item :style="_style" class="m-card-portrait"><img :src="item.HeadPortraits "></flexbox-item>
					<flexbox-item>
