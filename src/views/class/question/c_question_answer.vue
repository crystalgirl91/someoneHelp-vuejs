	...
	<div class="answer-sub">
		...
		<div class="block" v-if="selected === 2">
			<dl class="upload-pic-list clearfix">
				...
				<dd class="upload-pic upload-pic-btn" v-on:click="uploadpictures()">
...
<script type="text/javascript">
  ...
  export default {
        ...
        methods:{
            ...
            submit:function(){
              //提交
			  this.data.PK_AEID=this.$route.params.PK_AEID;
			  for(var i=0;i<this.images.length;i++){
			  ...
			  var _this=this;
              this.$http.post('/api/Student/NX_SetAnswer',this.data).then(res => {
                if(res.body.Data){
					alert("回复成功");
					history.go(-1);
                }
