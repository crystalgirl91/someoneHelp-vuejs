...
<div class="m-panel sm-panel">
	...
	<div class="sm-btn-group">
		<span class="color-red sm-panel-btn" v-link="{name:'question_buy',params:{id:id}}">赞赏</span>
		<span class="color-blue sm-panel-btn" v-link="{name:'discover_question_comment',params:{id:id}}">评论</span>
	</div>
</div>
</template>
<style>
	.sm-panel .sm-btn-group{
		text-align: center;
	}
	.sm-panel .sm-panel-btn{
		font-size: .36rem;
		padding: .4rem .5rem;
